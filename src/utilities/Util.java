...
//        String append = clustering.toString().replaceAll("[\\.\t]", "").replaceAll("[\\.=]", "");
        String append = clustering.toString().replaceAll("\\D+", "");;
    ...
    public static void printCopyright() {
        ...
        str.append("-----------------------------------------------------------------");
        str.append("\r\nCopyright (C) Khadija Musayeva, Lazaros Mavridis, University of St Andrews\r\n");
        str.append("Created: 2013\r\n");
        str.append("Last update: March 2015\r\n\r\n");

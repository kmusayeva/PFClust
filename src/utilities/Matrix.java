...
public class Matrix {
    ...
    /**
     * Represents the two dimensional array that holds pairwise similarities of
     * elements in the given data-set.
     */
    private double[][] data;
     ...
     * @param fileName
     */
    public Matrix(final String fileName) throws IOException, MissingFormatArgumentException {
    ...
    /**
     * @return the number of rows (it is a symmetric matrix, so the number of
    ...
    /**
     * Uses the FileChannel in order to efficiently read the input from the
     * specified file and constructs the corresponding two dimensional array
     *
     * @param fileName
     * @return two dimensional array of pairwise similarities between elements
     * in the provided data set.
     */
    private double[][] readMatrix(final String fileName) throws IOException, MissingFormatArgumentException {

/**
 * ********************************
 * Copyright (C) Khadija Musayeva, Lazaros Mavridis, University of St Andrews
 * Created: 2013
...
/**
 * This class implements the main loop and the convergence steps of the
 * algorithm.
 */
public class PFClust {
    ...
    /**
     * Array of files read from the input directory specified in the
     * configuration file.
     */
    ...
    /**
     * Represents the maximum number of iterations to execute the convergence
     * step of the algorithm.
     */
    public static int maxIteration = 10;

    /**
     * For each data set specified in the configuration file executes the
     * PFClust clustering
     *
    ...
    public static void run() {
        try {
            ...
            System.out.println("Error reading the config file. Please check that the config.txt file is in the same directory as the program file, or that it is configured properly.\r\n");
            return;
        }
        ...
        for (String fileName : FILES) {
            try {
               ...
               System.out.println("Error reading the input file. Please check that the input file is in the correct format.\r\n");
            }
        }
     ...
     * @return a Clustering
     */
    private static Clustering process(String fileName) throws IOException, MissingFormatArgumentException {
    ...
    /**
     * If the Rand index of the clustering collection is less than a specified
     * value, it builds a new clustering and replaces the worst clustering in
     * the list with the new one, if the new clustering is better than the worst
     * clustering in the list. The process continues unless the Rand index of
     * the collection is greater than 0.99
     *
